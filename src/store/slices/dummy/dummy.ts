    ...
    group: [
        {
            ...
            song: ['J.Sibelius Symphony No. 1', 'P.I.Tchaikovsky Symphony NO. 6'],
            friend: 8,
            region: '서초구',
            recruit: '모집 중',
        },
        {
            ...
            song: ['A.Borodin Symphony No. 2', 'H.Berlioz Symphony fantasique'],
            friend: 51,
            region: '관악구',
            recruit: '모집 마감',
        },
        {
            ...
            song: ['J.Brahms Academic festival','J.Sibelius Violin Concerto', 'J.Brahms Symphony No. 4'],
            friend: 4,
            region: '서초구',
            recruit: '모집 중',
        },
        {
            ...
            song: ['Rimsky Korsakov Scheherazade'],
            friend: 4,
            region: '관악구',
            recruit: '모집 마감',
        },
