import {Box, Button, ButtonGroup, Stack, TextField, Typography, useMediaQuery, useTheme} from "@mui/material";
...
const VisitList = (props : any) => {
    ...
    return(
        <Stack  sx={{width: '100%', mt:3}} justifyContent={res550 ? "center" : ''} alignItems={res550 ? "center" : ''} alignContent={res550 ? "center" : ''}>
            <Stack direction={res400 ? "column" : "row"} sx={{width: '90%', bgcolor: '#eeeeee', borderRadius: 10}}>
